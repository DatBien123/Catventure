...
public class WordChecker : MonoBehaviour
{
    ...
    private void OnEnable() {
        GameEvents.OnCheckSquare += GameEvents_OnCheckSquare;
        GameEvents.OnClearSelection += GameEvents_OnClearSelection;
        GameEvents.OnLoadNextLevel += GameEvents_OnLoadNextLevel;
    }
    ...
    private void GameEvents_OnLoadNextLevel() {
        SceneManager.LoadScene("Scenes/Minigame_WordSpy");
    }
    ...
    private void GameEvents_OnCheckSquare(string letter, Vector3 squarePosition, int squareIndex) {
