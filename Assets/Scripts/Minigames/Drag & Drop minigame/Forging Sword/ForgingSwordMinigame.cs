...
//    public IngredientRecipeSO recipe;
//    public Smithy smithy; // cái đe để rèn kiếm
//    public IngredientManager elementalManager;
...
//        IngredientSO elemental = recipe.requiredItems[0];

//        // duyệt qua các đĩa nguyên liệu đã tạo
//        foreach (GameObject ingredientPlate in elementals)
//        {
//            if (ingredientPlate.GetComponentInChildren<Ingredient>().ingredientData == elemental)
//            {
