...
public static class GameEvents
{
    ...
    //*****************************
    public delegate void UnlockNextCatergory();
    public static event BoardCompleted OnUnlockNextCatergory;

    public static void UnlockNextCategoryMethod() {
        if (OnUnlockNextCatergory != null)
            OnUnlockNextCatergory();
    }
    ...
    public static event GameOver OnToggleSoundFX;
