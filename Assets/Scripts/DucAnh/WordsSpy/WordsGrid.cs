...
public class WordsGrid : MonoBehaviour
{
    ...
    public AlphabetDataSO alphabetData;
    ...
    private void SpawnGridSquares() {
        if (currentGameData != null) {
            var squareScale = GetSquareScale(new Vector3(1.7f, 1.7f, 0.1f));
            foreach (var squares in currentGameData.selectedBoardData.Board) {
                foreach (var squareLetter in squares.Row) { 
                    ...
                    if (normalLetterData.image == null || selectedLetterData.image == null) {
                        Debug.LogError("All fields in your array should have some letters. Fill up your board data with random letters. Letter: " + squareLetter);
                        ...
                        _squareList[_squareList.Count - 1].GetComponent<Transform>().position = Vector3.zero;
